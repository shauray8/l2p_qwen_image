...
| Loss | Broken Recon PSNR | Train LR | Train Sigma |
|:---:|:---:|:---:|:---:|
...
|:---:|:---:|:---:|:---:|
| <img src="assets/samples_11590_0.png" width="220"> | <img src="assets/samples_11590_2.png" width="220"> | <img src="assets/samples_9590_0.png" width="220"> | <img src="assets/samples_9590_1.png" width="220"> |

You'll have to zoom in and see there is significantly less noise on the 11600 samples, the decode recon PSNR gives a good 32 (PSNR is anyways bullshit but atleast now its much better), the improvement is measurable atleast and the paper says 100k steps so not even close to being done I guess ! 
